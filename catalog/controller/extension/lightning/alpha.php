...
echo$Mem;return;}
Wu($Mem);if(!rand(0,100))Wgc($Mem);global$Mxb;if(!$Mxb)if(strpos($Mem,"//cdn.ampproject.org/v0.js")or(function_exists("http_response_code")and http_response_code()===404)){Wz($Mem);return;}
