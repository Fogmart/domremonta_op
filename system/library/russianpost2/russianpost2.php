...
class ClassRussianpost2 extends ClassLicense {
	...
	/* start 1410 */
	private $tarif_url = "http://softpodkluch.ru/API/RP2/DATA4.php";
	private $version_url = "http://softpodkluch.ru/API/RP2/data4_version.xml";
	private $config;
	private $db;
	/* end 1410 */
		...
		if( !empty($json[0]) )
		{
			...
			foreach($json as $item)
			{
				...
				$row = array(
					...
					'address_region'		=> isset($item['address']['index']) ? $item['address']['index'] : '',
					'address_house' 		=> isset($item['address']['region']) ? $item['address']['region'] : '',
					'address_index' 		=> isset($item['address']['place']) ? $item['address']['place'] : '',
					'address_manualInput' 	=> isset($item['address']['street']) ? $item['address']['street'] : '',
					'address_place' 		=> isset($item['address']['house']) ? $item['address']['house'] : '',
					'address_street' 		=> isset($item['address']['manualInput']) ? $item['address']['manualInput'] : '',
