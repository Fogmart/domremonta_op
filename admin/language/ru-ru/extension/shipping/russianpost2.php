...
$_['header_otprvka_pvz']             = 'ПВЗ для тарифа ЕКОН';
...
$_['text_tag_pvz_block']             = 'Информация о ПВЗ который выбрал покупатель (тариф ЕКАМ)';
...
$_['text_pvz_header']             = 'Выбор ПВЗ для тарифа ЕКОН';
$_['text_pvz_notice']             = 'Выбор ПВЗ - отображается на странице оформления заказа
при выполнении следующих условий:<br>
- Выбран сервис для доставки в ПВЗ (на данный момент это только ЕКОН)<br>
- Отображение ПВЗ включено в настройке: Вкладка Сервисы -> подвкладка ЕКОН -> опция "Отображать список ПВЗ"';
...
$_['default_tag_pvz_block']        = 'ПВЗ: {pvz_address} (#{pvz_number}), {pvz_worktime}';


$_['default_pvz_selectblock'] = '<select id="{select_id}" 
		onchange="event.stopPropagation(); event.preventDefault(); 
		setRPPVZFromSelect(this, 1);" style="margin-right: 10px; max-width: 60%;">
		{options}
...
$_['entry_api_otpravka_user_token'] = 'Токен авторизации';
