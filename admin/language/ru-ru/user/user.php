...
$_['error_password']        = 'Пароль должен быть от 8 до 20 символов!';
$_['error_password_val']    = 'Содержать хотя бы одну цифру, букву латинкого алфавита (большую и маленькую) и спецсимвол (!@#$*[]{}())!';
