...
<div id="content">
    <div class="page-header">
      ...
      <div class="pull-right float-right">
        <button type="button" id="btn_ocm_save" form="form-ocm" value="save" name="action" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fas fa-save"></i></button>
...
<script src="view/javascript/ocm/ocm.js?v=1.0.4" type="text/javascript"></script>
<script type="text/javascript"><!--
var ocm_tab;
