		...
		<?php /* end 0802 */ ?>
		 ...
		 <div class="form-group">
			...
			<select class="form-control"  name="russianpost2_is_ignore_user_postcode"> 
              <?php if ($russianpost2_is_ignore_user_postcode) { ?>
              <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
              <option value="0"><?php echo $text_disabled; ?></option>
              <?php } else { ?>
              <option value="1"><?php echo $text_enabled; ?></option>
				...
				<tbody class="tbody"> 
					...
					<tr id="submethod-row<?php echo $method_row; ?>-<?php echo $submethod_row[$method_row]; ?>">
						  ...
						  <td class="text-left">
							...
							<input type="hidden" name="russianpost2_methods[<?php echo $method_row; ?>][submethods][<?php echo $submethod_row[$method_row]; ?>][image]" value="<?php echo $submethod['image']; ?>" 
...
<?php } } ?>					
		...
		<div id="tab-packs" class="tab-pane">
			...
			<table id="packs" class="table table-striped table-bordered table-hover">
				<thead>
				  <tr>
					<td class="text-left"><?php echo $col_packs_name; ?></td>
					<td class="text-left"><?php echo $col_packs_sizes; ?></td>
...
html  += '<input type="hidden" name="russianpost2_methods[' + method_row + '][submethods]['+submethod_row[method_row]+'][image]"  id="input-image' + method_row + '-'+submethod_row[method_row]+'" value="<?php echo $default_image; ?>" />';
html  += '</div>';
...
{
	$.ajax({
		url: 'index.php?route='+encodeURIComponent('extension/shipping/russianpost2/saveTab')+'&token=<?php echo $token; ?>'+
		'&tab_id='+tab_id+
        ...
        error: function(xhr, ajaxOptions, thrownError) {
			...
			$.ajax({
				url: 'index.php?route='+encodeURIComponent('extension/shipping/russianpost2/logError')+'&token=<?php echo $token; ?>',
				type: 'post',
...
$(document).ready(function() {
	$.ajax({
		url: 'index.php?route=extension/shipping/russianpost2/getVersionStatus&token=<?php echo $token; ?>',
		dataType: 'html',	
