<?php
class ControllerExtensionShippingRussianpost2 extends Controller {
	...
	public function setlicense()
	{
		...
		$this->load->language('extension/shipping/russianpost2');
		...
		$this->response->redirect($this->url->link('extension/shipping/russianpost2', 'token=' . $this->session->data['token'], 'SSL') );
	}
	...
	private function licensePage( $lstatus = 0 )
	{
		...
		$this->load->model('extension/shipping/russianpost2');
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
       		'href'      => $this->url->link('extension/shipping/russianpost2', 'token=' . $this->session->data['token'], 'SSL'),
		...
		if( !$this->model_extension_shipping_russianpost2->getRubCode() )
		{
		...
		$this->data['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'].'&type=shipping', 'SSL');
		
		$this->data['action'] = $this->url->link('extension/shipping/russianpost2/setlicense', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/shipping/russianpost2_license', $this->data));
	}
	...
	public function saveTab()
	{
		...
		if( $tab_id == 'tab-methods' )
		{
			...
			$this->model_extension_shipping_russianpost2->updateExtentions( 
				isset($this->request->post['russianpost2_methods']) ? 
				$this->request->post['russianpost2_methods'] : array() 
			);
		}
		
		$this->model_extension_shipping_russianpost2->customEditSetting('russianpost2', 
			$this->request->post);
		
		if( $tab_id == 'tab-methods' )
		{
			$this->model_extension_shipping_russianpost2->saveCurrentMethods( 
				isset($this->request->post['russianpost2_methods']) ? 
				$this->request->post['russianpost2_methods'] : array() 
			);
		}
		...
		{
			$this->model_extension_shipping_russianpost2->saveCustoms( 
		...
		{
			$alert1 = $this->model_extension_shipping_russianpost2->saveFilters( 'order', 
			...
			$alert2 = $this->model_extension_shipping_russianpost2->saveFilters( 'product', 
		...
		if( $tab_id == 'tab-adds' )
		{
			$this->model_extension_shipping_russianpost2->saveAdds( 'product', 
				isset($this->request->post['russianpost2_product_adds']) ? 
				$this->request->post['russianpost2_product_adds'] : array() 
			);
			
			$this->model_extension_shipping_russianpost2->saveAdds( 'method', 
				isset($this->request->post['russianpost2_method_adds']) 
				? 
				$this->request->post['russianpost2_method_adds'] : array() 
			);
			
			$this->model_extension_shipping_russianpost2->saveAdds( 'order', 
		...
		{
			$this->model_extension_shipping_russianpost2->saveCountries( 
		...
		if( !empty($this->request->get['is_end']) )
		{
			...
			{
				$json['redirect'] = $this->url->link('extension/extension', 
			...
			else
			{
				...
				$json['redirect'] = $this->url->link('extension/shipping/russianpost2', 
	...
	public function index() 
	{
		...
		/* start metka-1 */
		$this->data['clear_cache'] = $this->url->link('extension/shipping/russianpost2/clearCache', 'token=' . $this->session->data['token'], 'SSL');
		...
		$delivery_types = $this->model_extension_shipping_russianpost2->getDeliveryTypes();
		...
		list($this->data['module_version'], $this->data['sfp_version'], $min_module_version_for_sfp, $min_module_version_for_work) = $this->model_extension_shipping_russianpost2->getVersions();
		...
		$this->data['zones'] = $this->model_extension_shipping_russianpost2->getRussianZones();
		...
		foreach ($this->data['languages'] as $i=>$result) {
			...
			$language->load('extension/shipping/russianpost2');	
		...
		$this->data['update_pvz_action'] = $this->url->link('extension/shipping/russianpost2/uploadPvz', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->data['russianpost2_customs'] = $this->model_extension_shipping_russianpost2->getCustoms(); 
		/* end 2801 */
		...
		$this->data['synx_link'] =  $this->url->link('extension/shipping/russianpost2/synx', 'token=' . $this->session->data['token'], 'SSL');
		...
		$russianpost2_method_adds = $this->model_extension_shipping_russianpost2->getAdds('method');
		...
		$this->data['update_action'] = $this->url->link('extension/shipping/russianpost2/uploadt', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['russianpost2_from_region'])) {
			...
			$moscow = $this->model_extension_shipping_russianpost2->getMoscowRegion();
		...
		$packs = $this->model_extension_shipping_russianpost2->getPacks();
		...
		$russianpost2_product_filters_data = $this->model_extension_shipping_russianpost2->getFilters('product');
		...
		$russianpost2_order_filters_data = $this->model_extension_shipping_russianpost2->getFilters('order');
		...
		$russianpost2_product_adds_data = $this->model_extension_shipping_russianpost2->getAdds('product');
		...
		$russianpost2_order_adds_data = $this->model_extension_shipping_russianpost2->getAdds('order');
		...
		$configs_list = $this->model_extension_shipping_russianpost2->getEditableConfig();
		...
		$services = $this->model_extension_shipping_russianpost2->getDedicatedServices();
		...
		$top_services_list = $this->model_extension_shipping_russianpost2->getServices( "top" );
		
		foreach($top_services_list as $service)
		{
			$service['options'] = $this->model_extension_shipping_russianpost2->getServiceOptions( $service['service_key'] );
		...
		if( !$this->model_extension_shipping_russianpost2->getGramm() )
		{
			$this->error['warning2'] = $this->language->get('err_not_gramm');
		}
		
		if( !$this->model_extension_shipping_russianpost2->getCm() )
		{
		...
		$this->data['action'] = $this->url->link('extension/shipping/russianpost2', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->data['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'].'&type=shipping', 'SSL');
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
       		'text'      => $this->language->get('heading_title'),
			'href'      => $this->url->link('extension/shipping/russianpost', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		...
		$this->response->setOutput($this->load->view('extension/shipping/russianpost2', $this->data));
	}
	...
	public function uploadPvz()
	{
		...
		if( !$this->config->get('russianpost2_api_otpravka_token') )
		{
			...
			$this->response->redirect(
				$this->url->link('extension/shipping/russianpost2', 
	...
	public function uploadt()
	{
		...
		$this->response->redirect($this->url->link('extension/shipping/russianpost2', 'token=' . $this->session->data['token']) );
	}
	...
	protected function validate() {
		...
		if (!$this->user->hasPermission('modify', 'extension/shipping/russianpost2')) {
		...
		$notop_services_list = $this->model_extension_shipping_russianpost2->getServices( "notop" );
		$notop_hash = array();
	...
	public function clearCache()
	{
		...
		$this->model_extension_shipping_russianpost2->clearCache();
